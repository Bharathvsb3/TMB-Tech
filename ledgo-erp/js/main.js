(function () {
  ...
  var TRANSLATIONS = {
    en: {
      ...
      "f1.body": "Search, scan, or speak a product in — GST splits itself into CGST+SGST or IGST on every line, automatically, and a UPI QR sits on every bill so customers can pay on the spot.",
      ...
      "f8.li3": "A UPI QR sits on every bill — customers scan it and pay on the spot",
    ...
    ta: {
      ...
      "nav.devices": "எல்லா சாதனங்களிலும்",
      ...
      "f1.body": "பொருளைத் தேடுங்கள், ஸ்கேன் செய்யுங்கள், அல்லது சொல்லுங்கள் — ஒவ்வொரு வரியிலும் ஜிஎஸ்டி தானாகவே CGST+SGST அல்லது IGST ஆக பிரிந்துவிடும், மேலும் ஒவ்வொரு பில்லிலும் UPI QR இருப்பதால் வாடிக்கையாளர் உடனே பணம் செலுத்தலாம்.",
      ...
      "f8.li3": "ஒவ்வொரு பில்லிலும் UPI QR இருக்கும் — வாடிக்கையாளர் ஸ்கேன் செய்து உடனே செலுத்தலாம்",
    ...
    hi: {
      ...
      "f1.body": "उत्पाद खोजें, स्कैन करें, या बोलकर जोड़ें — हर लाइन पर जीएसटी अपने आप CGST+SGST या IGST में बंट जाता है, और हर बिल पर एक UPI QR होता है ताकि ग्राहक तुरंत भुगतान कर सके।",
      ...
      "f8.li3": "हर बिल पर एक UPI QR होता है — ग्राहक स्कैन करके तुरंत भुगतान कर सकता है",
    ...
    kn: {
      ...
      "f1.body": "ಉತ್ಪನ್ನವನ್ನು ಹುಡುಕಿ, ಸ್ಕ್ಯಾನ್ ಮಾಡಿ, ಅಥವಾ ಹೇಳಿ ಸೇರಿಸಿ — ಪ್ರತಿ ಸಾಲಿನಲ್ಲೂ ಜಿಎಸ್‌ಟಿ ತಾನಾಗಿಯೇ CGST+SGST ಅಥವಾ IGST ಆಗಿ ವಿಭಜನೆಯಾಗುತ್ತದೆ, ಮತ್ತು ಪ್ರತಿ ಬಿಲ್‌ನಲ್ಲೂ UPI QR ಇರುವುದರಿಂದ ಗ್ರಾಹಕರು ತಕ್ಷಣ ಪಾವತಿಸಬಹುದು.",
      ...
      "f8.li3": "ಪ್ರತಿ ಬಿಲ್‌ನಲ್ಲೂ UPI QR ಇರುತ್ತದೆ — ಗ್ರಾಹಕರು ಸ್ಕ್ಯಾನ್ ಮಾಡಿ ತಕ್ಷಣ ಪಾವತಿಸಬಹುದು",
    ...
    te: {
      ...
      "f1.body": "ఉత్పత్తిని వెతకండి, స్కాన్ చేయండి, లేదా చెప్పి చేర్చండి — ప్రతి లైన్‌లో జీఎస్టీ దానంతట అదే CGST+SGST లేదా IGST గా విడిపోతుంది, ప్రతి బిల్లుపై UPI QR ఉండటం వల్ల కస్టమర్ వెంటనే చెల్లించవచ్చు.",
      ...
      "f8.li3": "ప్రతి బిల్లుపై UPI QR ఉంటుంది — కస్టమర్ స్కాన్ చేసి వెంటనే చెల్లించవచ్చు",
